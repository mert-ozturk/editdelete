  ...
  return (
    <div className="app-container">
      ...
      <form onSubmit={handleAddFormSubmit}>
        ...
        <input type='text' name='adress' required="required" placeholder='Enter Adress' onChange={handleAddFormChange} />
        <input type='text' name='phoneNumber' required="required" placeholder='Enter phoneNumber' onChange={handleAddFormChange} />
